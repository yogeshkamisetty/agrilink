...
export type UserProfile = { id: string; role: 'farmer' | 'buyer' | 'admin' | null; full_name: string | null; mobile_number: string | null; village: string | null; district: string | null; state: string | null; fpo_name: string | null; organization_name: string | null; organization_type: string | null; verification_status: 'pending' | 'verified' | 'rejected'; onboarding_complete: boolean; last_login_at: string | null; last_logout_at: string | null; created_at: string; updated_at: string }
