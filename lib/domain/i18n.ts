...
export const SPEECH_LOCALE: Record<Lang, string> = { en: 'en-IN', hi: 'hi-IN', gu: 'gu-IN' }
...
const CROP_NAMES: Record<CropId, Record<Lang, string>> = {
  TOMATO: { en: 'tomato', hi: 'टमाटर', gu: 'ટામેટાં' },
  SPINACH: { en: 'spinach', hi: 'पालक', gu: 'પાલક' },
  ONION: { en: 'onion', hi: 'प्याज़', gu: 'ડુંગળી' },
  POTATO: { en: 'potato', hi: 'आलू', gu: 'બટાકા' },
  BAJRA: { en: 'bajra', hi: 'बाजरा', gu: 'બાજરી' },
  TUR: { en: 'tur', hi: 'तुअर', gu: 'તુવેર' },
}
...
const DATE_LOCALE: Record<Lang, string> = { en: 'en-IN', hi: 'hi-IN', gu: 'gu-IN' }
...
export const UI: Record<string, Record<Lang, string>> = {
  inbox: { en: 'AgriLink messages', hi: 'AgriLink संदेश', gu: 'AgriLink સંદેશા' },
  accept: { en: 'Accept', hi: 'स्वीकार करें', gu: 'સ્વીકારો' },
  decline: { en: 'Decline', hi: 'मना करें', gu: 'ના પાડો' },
  qtyLabel: { en: 'How many kg can you supply?', hi: 'आप कितने किलो दे सकते हैं?', gu: 'તમે કેટલા કિલો આપી શકો?' },
  commit: { en: 'Commit', hi: 'पक्का करें', gu: 'પાકું કરો' },
  cancel: { en: 'Back', hi: 'वापस', gu: 'પાછા' },
  withdraw: { en: "Can't supply any more", hi: 'अब सप्लाई संभव नहीं', gu: 'હવે સપ્લાય શક્ય નથી' },
  withdrawConfirm: { en: 'Withdraw from this order? Standby farmers will be called instead.', hi: 'इस ऑर्डर से हटना है? आपकी जगह स्टैंडबाय किसानों को बुलाया जाएगा।', gu: 'આ ઑર્ડરમાંથી નીકળવું છે? તમારી જગ્યાએ સ્ટેન્ડબાય ખેડૂતોને બોલાવવામાં આવશે.' },
  yes: { en: 'Yes, withdraw', hi: 'हाँ, हटें', gu: 'હા, નીકળો' },
  playIvr: { en: 'Play voice call', hi: 'वॉइस कॉल सुनें', gu: 'વૉઇસ કૉલ સાંભળો' },
  stopIvr: { en: 'Stop', hi: 'रोकें', gu: 'બંધ કરો' },
  youReplied: { en: 'You replied', hi: 'आपने जवाब दिया', gu: 'તમે જવાબ આપ્યો' },
  accepted: { en: 'Accepted', hi: 'स्वीकार', gu: 'સ્વીકાર્યું' },
  declined: { en: 'Declined', hi: 'मना किया', gu: 'ના પાડી' },
  orderClosed: { en: 'This order is closed.', hi: 'यह ऑर्डर अब बंद है।', gu: 'આ ઑર્ડર હવે બંધ છે.' },
  noMessages: {
  ...
  mySales: { en: 'My sales', hi: 'मेरी बिक्री', gu: 'મારું વેચાણ' },
  kg: { en: 'kg', hi: 'किलो', gu: 'કિલો' },
  gradedWeight: { en: 'Graded weight', hi: 'ग्रेड किया गया वज़न', gu: 'ગ્રેડ કરેલું વજન' },
  agreedPrice: { en: 'Agreed price', hi: 'तय भाव', gu: 'નક્કી ભાવ' },
  gross: { en: 'Gross value', hi: 'कुल रकम', gu: 'કુલ રકમ' },
  advancePaid: { en: 'Advance paid on harvest day', hi: 'कटाई के दिन मिला एडवांस', gu: 'કાપણીના દિવસે મળેલું એડવાન્સ' },
  transport: { en: 'Transport share', hi: 'ढुलाई का हिस्सा', gu: 'ભાડાનો હિસ્સો' },
  net: { en: 'Balance paid at settlement', hi: 'हिसाब पर बाकी भुगतान', gu: 'હિસાબ વખતે બાકી ચુકવણી' },
  totalReceived: { en: 'Total received', hi: 'कुल प्राप्त', gu: 'કુલ મળેલું' },
  realised: { en: 'You realised', hi: 'आपको मिला', gu: 'તમને મળ્યું' },
  mandi: { en: 'Mandi price that day', hi: 'उस दिन का मंडी भाव', gu: 'તે દિવસનો મંડી ભાવ' },
  perKg: { en: '/kg', hi: '/किलो', gu: '/કિલો' },
  noSales: { en: 'No settled sales yet.', hi: 'अभी कोई बिक्री का हिसाब नहीं।', gu: 'હજુ કોઈ વેચાણનો હિસાબ નથી.' },
  grade: { en: 'Grade', hi: 'ग्रेड', gu: 'ગ્રેડ' },
  standby: { en: 'Standby', hi: 'स्टैंडबाय', gu: 'સ્ટેન્ડબાય' },
  confirmed: { en: 'Confirmed', hi: 'पक्का', gu: 'પાકું' },
  commitRange: { en: 'Enter 1 to {max} kg', hi: '1 से {max} किलो लिखें', gu: '1 થી {max} કિલો લખો' },
}
