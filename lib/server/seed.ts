...
const FARMERS: FarmerSeed[] = [
  { key: 'ramesh', name: 'Rameshbhai Patel', phone: '+91 90000 10101', language: 'gu', landHectares: 0.8, village: 'Boriavi', lat: 22.6167, lng: 72.9333, crops: [{ crop: 'TOMATO', kg: 50, window: [-7, 21] }], reply: { afterHours: 0.8, response: 'ACCEPT', qty: 50 } },
  { key: 'savita', name: 'Savitaben Parmar', phone: '+91 90000 10102', language: 'gu', landHectares: 1.2, village: 'Petlad', lat: 22.4768, lng: 72.7998, crops: [{ crop: 'TOMATO', kg: 70, window: [-7, 21] }, { crop: 'POTATO', kg: 400, window: [-20, 15] }], reply: { afterHours: 1.6, response: 'ACCEPT', qty: 70 } },
  { key: 'mohan', name: 'Mohanbhai Solanki', phone: '+91 90000 10103', language: 'gu', landHectares: 1.5, village: 'Sojitra', lat: 22.5387, lng: 72.7195, crops: [{ crop: 'TOMATO', kg: 80, window: [-5, 21] }], reply: { afterHours: 2.4, response: 'ACCEPT', qty: 80 } },
  { key: 'jignesh', name: 'Jignesh Chauhan', phone: '+91 90000 10104', language: 'gu', landHectares: 1.0, village: 'Bakrol', lat: 22.5796, lng: 72.958, crops: [{ crop: 'TOMATO', kg: 60, window: [-7, 21] }, { crop: 'POTATO', kg: 300, window: [-20, 15] }], reply: { afterHours: 3.0, response: 'DECLINE' } },
  { key: 'laxmi', name: 'Laxmiben Vaghela', phone: '+91 90000 10105', language: 'gu', landHectares: 0.4, village: 'Umreth', lat: 22.6986, lng: 73.1149, crops: [{ crop: 'TOMATO', kg: 30, window: [-3, 21] }], reply: { afterHours: 7.0, response: 'ACCEPT', qty: 30 } },
  { key: 'kokila', name: 'Kokilaben Rathod', phone: '+91 90000 10106', language: 'gu', landHectares: 0.6, village: 'Karamsad', lat: 22.5433, lng: 72.9046, crops: [{ crop: 'TOMATO', kg: 40, window: [-7, 21] }], reply: { afterHours: 99, response: 'NONE' } },
  { key: 'harshad', name: 'Harshad Makwana', phone: '+91 90000 10107', language: 'gu', landHectares: 0.9, village: 'Mahudha', lat: 22.8205, lng: 72.9406, crops: [{ crop: 'TOMATO', kg: 45, window: [25, 45] }] },
  { key: 'suresh', name: 'Suresh Yadav', phone: '+91 90000 10108', language: 'hi', landHectares: 0.5, village: 'Kheda', lat: 22.7507, lng: 72.6847, crops: [{ crop: 'TOMATO', kg: 55, window: [-7, 21] }] },
  { key: 'bhavna', name: 'Bhavnaben Thakor', phone: '+91 90000 10109', language: 'gu', landHectares: 1.8, village: 'Borsad', lat: 22.4078, lng: 72.8988, crops: [{ crop: 'ONION', kg: 300, window: [-30, 10] }], reply: { afterHours: 1.2, response: 'ACCEPT', qty: 200 } },
  { key: 'pooja', name: 'Pooja Devi Kushwaha', phone: '+91 90000 10110', language: 'hi', landHectares: 0.7, village: 'Vasad', lat: 22.455, lng: 73.0697, crops: [{ crop: 'ONION', kg: 250, window: [-30, 10] }], reply: { afterHours: 2.0, response: 'ACCEPT', qty: 150 } },
  { key: 'nitin', name: 'Nitin Dabhi', phone: '+91 90000 10111', language: 'en', landHectares: 1.1, village: 'Anklav', lat: 22.3833, lng: 73.0, crops: [{ crop: 'ONION', kg: 200, window: [-30, 10] }, { crop: 'BAJRA', kg: 150, window: [-90, -60] }], reply: { afterHours: 6.5, response: 'ACCEPT', qty: 150 } },
  { key: 'manjula', name: 'Manjulaben Rabari', phone: '+91 90000 10112', language: 'gu', landHectares: 1.3, village: 'Vaso', lat: 22.66, lng: 72.755, crops: [{ crop: 'ONION', kg: 150, window: [-30, 10] }, { crop: 'BAJRA', kg: 120, window: [-90, -60] }], reply: { afterHours: 8.0, response: 'ACCEPT', qty: 100 } },
]
