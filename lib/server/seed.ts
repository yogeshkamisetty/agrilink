...
const FARMERS: FarmerSeed[] = [
  ...
  { key: 'laxmi', name: 'Laxmiben Vaghela', phone: '+91 90000 10105', language: 'gu', landHectares: 0.4, village: 'Umreth', lat: 22.6986, lng: 73.1149, crops: [{ crop: 'TOMATO', kg: 30, window: [-3, 30] }, { crop: 'PADDY', kg: 300, window: [-10, 60] }], reply: { afterHours: 7.0, response: 'ACCEPT', qty: 30 } },
  { key: 'kokila', name: 'Kokilaben Rathod', phone: '+91 90000 10106', language: 'gu', landHectares: 0.6, village: 'Karamsad', lat: 22.5433, lng: 72.9046, crops: [{ crop: 'TOMATO', kg: 40, window: [-7, 30] }], reply: { afterHours: 99, response: 'NONE' } },
  { key: 'harshad', name: 'Harshad Makwana', phone: '+91 90000 10107', language: 'gu', landHectares: 0.9, village: 'Mahudha', lat: 22.8205, lng: 72.9406, crops: [{ crop: 'TOMATO', kg: 45, window: [25, 60] }] },
  ...
  { key: 'bhavna', name: 'Bhavnaben Thakor', phone: '+91 90000 10109', language: 'gu', landHectares: 1.8, village: 'Borsad', lat: 22.4078, lng: 72.8988, crops: [{ crop: 'ONION', kg: 300, window: [-30, 30] }], reply: { afterHours: 1.2, response: 'ACCEPT', qty: 200 } },
  ...
  { key: 'manjula', name: 'Manjulaben Rabari', phone: '+91 90000 10112', language: 'gu', landHectares: 1.3, village: 'Vaso', lat: 22.66, lng: 72.755, crops: [{ crop: 'ONION', kg: 150, window: [-30, 30] }, { crop: 'BAJRA', kg: 120, window: [-90, 60] }], reply: { afterHours: 8.0, response: 'ACCEPT', qty: 100 } },
]
