...
export function BolnaCallModal({
  ...
  const scriptPreviews = {
    ...
    en: `Hello ${farmer.name}! This is the AgriLink AI Voice Agent calling on behalf of Mahi Valley FPO. A new bulk procurement order (${orderCode}) for ${cropName} has been confirmed by ${buyerName}. Your farm allocation under our aggregation plan is ${allocatedKg} KG at a guaranteed price of ₹${pricePerKg}/kg. Can you please confirm if you are capable of supplying this harvest for collection on ${deliveryDate}?`,
  }
