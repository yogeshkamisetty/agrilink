...
const STAGE_LABELS: Record<string, Record<string, string>> = {
  ...
  gu: {
    POSTED: 'ઓર્ડર દાખલ થયો',
    FUNDED: 'એડવાન્સ સુરક્ષિત',
    SOURCING: 'પાક એકત્રીકરણ ચાલુ',
    COLLECTING: 'પિકઅપ અને ચકાસણી',
    DISPATCHED: 'વાહન રસ્તામાં છે',
    SETTLED: 'બેંકમાં ચુકવણી પૂર્ણ',
    REJECTED: 'રદ કરેલ',
  },
}
...
const LABELS: Record<string, Record<string, string>> = {
  ...
  gu: {
    welcome: 'નમસ્તે',
    memberBadge: 'પ્રમાણિત FPO સભ્ય',
    tagline: 'પાક લણણી પહેલાં જ ખરીદદાર સાથે નક્કી કરેલ ગેરંટીવાળા ભાવે પાક વેચો.',
    declareBtn: 'નવો પાક નોંધાવો',
    declareSub: 'તમે જે પાક લણવાના છો તેની વિગત આપો જેથી ખરીદદારો સીધો ઓર્ડર આપી શકે',
    voiceBtn: 'બોલીને પૂછો',
    allocatedTitle: 'તમારા માટે નવો ઓર્ડર આવ્યો છે!',
    allocatedSub: 'ખરીદદારે ઓર્ડર આપ્યો છે અને તમારા ખેતરમાં પાક તૈયાર હોવાથી સૌથી નજીકના સભ્ય તમે છો.',
    priceAgreed: 'નક્કી ભાવ',
    mandiBenchmark: 'મંડી ભાવ',
    extraGain: 'વધારાનો નફો',
    deliverBy: 'પિકઅપ તારીખ',
    buyerLabel: 'ખરીદદાર',
    acceptOrder: 'ઓર્ડર સ્વીકારો',
    declineOrder: 'ના પાડો (આગામી ખેડૂતને આપો)',
    declineNotice: 'અસ્વીકાર કરવાથી આ ઓર્ડર આપમેળે તમારા FPO ના આગામી નજીકના ખેડૂતને મોકલવામાં આવશે.',
    committedProduce: 'નક્કી કરેલ પાક',
    committedWorth: 'કુલ મૂલ્ય',
    vsMandi: 'મંડી કરતાં વધારાનો નફો',
    vsMandiSub: 'સ્થાનિક APMC ભાવ કરતાં વધુ',
    nextPickup: 'આગામી પિકઅપ',
    noPickup: 'હજુ કોઈ પિકઅપ નક્કી નથી',
    received: 'બેંકમાં મળેલ કુલ નાણાં',
    receivedSub: 'એડવાન્સ + આખરી ચુકવણી',
    tabCrops: 'મારો પાક અને ઉપાડ',
    tabDemands: 'ખરીદદારની માંગ',
    tabQuality: 'ગુણવત્તા ચકાસણી (GradeCam)',
    tabPassbook: 'પાસબુક અને આવક',
    registeredHarvests: 'મારા નોંધાયેલા પાક',
    addCrop: 'પાક ઉમેરો',
    ofCommitted: 'વચન આપ્યું',
    availableToSell: 'વેચાણ માટે ઉપલબ્ધ',
    harvestWindow: 'લણણીનો સમયગાળો',
    activeCommitments: 'મારા ડિલિવરી ઓર્ડર્સ',
    noCommitments: 'હજુ કોઈ ઓર્ડર નથી. ખરીદદાર માંગ ટેબમાં જઈને તમારો પાક નોંધાવો.',
    fpoUpdates: 'FPO ના સત્તાવાર સંદેશા',
    noMessages: 'પિકઅપ, વજન અને ચુકવણીની પુષ્ટિના સંદેશા અહીં દેખાશે.',
    openDemandsTitle: 'ખરીદદારોની હાલની માંગ',
    openDemandsSub: 'ખરીદદારો દ્વારા એડવાન્સ જમા થયેલ ઓર્ડર્સ.',
    noDemands: 'હાલમાં કોઈ ખુલ્લી માંગ ઉપલબ્ધ નથી.',
    commitBtn: 'પાક આપવા સંમત થાઓ',
    registerToCommit: 'આ ઓર્ડર માટે પાક નોંધાવો',
    comingUp: 'આગામી માંગો (આયોજન માટે)',
    comingUpSub: 'એડવાન્સની રાહ જોતા ઓર્ડર્સ. આગામી લણણીના આયોજન માટે ઉપયોગી.',
    cameraTitle: 'GradeCam ફોટો ગુણવત્તા ચકાસણી',
    cameraSub: 'વાહન આવે તે પહેલાં પાકના 4-5 નમૂનાનો ફોટો લો. AI તરત જ AGMARK ગ્રેડ જણાવશે.',
    cameraHelp: 'પાકને સ્વચ્છ જગ્યાએ અને સારા અજવાળામાં રાખી ફોટો લો.',
    checkingPhoto: 'ફોટો ચકાસાઈ રહ્યો છે…',
    aiGradeSuggested: 'સૂચવેલ ગ્રેડ',
    confidence: 'ચોકસાઈ',
    gradedLotsTitle: 'ચકાસાયેલ અને વજન કરેલ પાક',
    noGradedLots: 'ખેતરે વજન થયા પછી વિગત અહીં દેખાશે.',
    passbookTitle: 'ખેડૂત પાસબુક',
    noPassbook: 'પ્રથમ ડિલિવરી પછી સંપૂર્ણ હિસાબ અહીં દેખાશે.',
    grossCropValue: 'પાકનું કુલ મૂલ્ય',
    advanceDeducted: 'મળેલ એડવાન્સ',
    transportShare: 'વાહન ભાડાનો હિસ્સો',
    finalBalancePaid: 'બેંકમાં જમા આખરી રકમ',
    realisedAboveMandi: 'મંડી ભાવ કરતાં વધુ મળ્યા',
    howPaidTitle: 'સીધી અને પારદર્શક ચુકવણી પ્રક્રિયા',
    howPaid1: '1. એડવાન્સ: પાકનું વજન થતાં જ 50% એડવાન્સ તમારા બેંક ખાતામાં જમા થાય છે.',
    howPaid2: '2. આખરી ચુકવણી: માલ ખરીદદાર પાસે પહોંચતાં જ બાકીની રકમ તરત બેંકમાં જમા થાય છે.',
    howPaid3: '3. શૂન્ય કમિશન: માત્ર નક્કી કરેલ વાહન ભાડું કપાશે, કોઈ છુપી દલાલી નહીં.',
    kisanHelpline: 'કિસાન કૉલ સેન્ટર (ટોલ-ફ્રી)',
    callHelplineBtn: 'કિસાન હેલ્પલાઇન 1800-180-1551 પર કૉલ કરો',
  },
}
